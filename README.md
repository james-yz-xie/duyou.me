...
1. **大模型不是魔法：软件工程原则在 AI 时代的生存指南** (2026-06-04)
   - 证明经典软件工程原则（SOLID、KISS、DRY等）在 AI 时代依然有效
   
2. **从原则到模式：AI 系统的工程化落地** (2026-06-05)
   - 回答"原则知道了，具体怎么做？"的工程实践问题
   
3. **从控制到引导：AI 时代的架构师进化论** (2026-06-06)
   - 探讨当基础设施成熟后，架构师的不可替代性在哪里